...
Shader "Hidden/AmplifyShaderPack/Terrain/Snow AddPass"
{
	Properties
	{
		...
		[Header(SNOW)]_SnowBaseColor("Snow Base Color", 2D) = "white" {}
		_SnowSaturation("Saturation", Range( 0 , 1)) = 0.5
		_SnowCoverageAmount("Coverage Amount", Range( -1 , 1)) = 0
		_SnowCoverageFalloff("Coverage Falloff", Range( 0 , 1)) = 0
		[Normal]_SnowNormal("Snow Normal", 2D) = "bump" {}
		_SnowNormalIntensity("Normal Intensity", Float) = 1
	...
	UsePass "Hidden/Nature/Terrain/Utilities/SELECTION"
		...
		Pass
		{
			...
			float _Metallic0;
			half _NormalScale3;
			float _SnowCoverageFalloff;
			half _NormalScale1;
			half _NormalScale0;
			float _Smoothness2;
			float _SnowCoverageAmount;
			float _SnowNormalIntensity;
			float _SnowSaturation;
			half _NormalScale2;
			float _Smoothness3;
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_SnowBaseColor = IN.ase_texcoord8.zw * _SnowBaseColor_ST.xy + _SnowBaseColor_ST.zw;
				float3 temp_output_12_0_g15 = (SAMPLE_TEXTURE2D( _SnowBaseColor, sampler_SnowBaseColor, uv_SnowBaseColor )).rgb;
				float dotResult28_g15 = dot( float3(0.2126729,0.7151522,0.072175) , temp_output_12_0_g15 );
				float3 temp_cast_1 = (dotResult28_g15).xxx;
				float3 lerpResult31_g15 = lerp( temp_cast_1 , temp_output_12_0_g15 , _SnowSaturation);
				float3 SnowBaseColor656_g14 = lerpResult31_g15;
				float2 uv_SnowNormal = IN.ase_texcoord8.zw * _SnowNormal_ST.xy + _SnowNormal_ST.zw;
				float3 unpack643_g14 = UnpackNormalScale( SAMPLE_TEXTURE2D( _SnowNormal, sampler_SnowNormal, uv_SnowNormal ), _SnowNormalIntensity );
				unpack643_g14.z = lerp( 1, unpack643_g14.z, saturate(_SnowNormalIntensity) );
				float3 tanToWorld0 = float3( WorldTangent.x, WorldBiTangent.x, WorldNormal.x );
				float3 tanToWorld1 = float3( WorldTangent.y, WorldBiTangent.y, WorldNormal.y );
				float3 tanToWorld2 = float3( WorldTangent.z, WorldBiTangent.z, WorldNormal.z );
				float3 tanNormal647_g14 = unpack643_g14;
				float3 worldNormal647_g14 = float3(dot(tanToWorld0,tanNormal647_g14), dot(tanToWorld1,tanNormal647_g14), dot(tanToWorld2,tanNormal647_g14));
				float SnowMask654_g14 = pow( saturate( ( saturate( ( ( 0.5 - 0.0 ) / ( (worldNormal647_g14).y - 0.0 ) ) ) + _SnowCoverageAmount ) ) , _SnowCoverageFalloff );
				float3 lerpResult674_g14 = lerp( localClipHoles453_g14 , SnowBaseColor656_g14 , SnowMask654_g14);
				...
				float3 staticSwitch503_g14 = appendResult514_g14;
				#endif
				float3 SnowNormal657_g14 = unpack643_g14;
				float3 lerpResult677_g14 = lerp( staticSwitch503_g14 , SnowNormal657_g14 , SnowMask654_g14);
				...
				float3 BaseColor = saturate( lerpResult674_g14 );
				float3 Normal = lerpResult677_g14;
				float3 Emission = 0;
				float3 Specular = 0.5;
	...
	UsePass "Hidden/Nature/Terrain/Utilities/SELECTION"
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv_SnowBaseColor = IN.ase_texcoord4.zw * _SnowBaseColor_ST.xy + _SnowBaseColor_ST.zw;
				float3 temp_output_12_0_g15 = (SAMPLE_TEXTURE2D( _SnowBaseColor, sampler_SnowBaseColor, uv_SnowBaseColor )).rgb;
				float dotResult28_g15 = dot( float3(0.2126729,0.7151522,0.072175) , temp_output_12_0_g15 );
				float3 temp_cast_1 = (dotResult28_g15).xxx;
				float3 lerpResult31_g15 = lerp( temp_cast_1 , temp_output_12_0_g15 , _SnowSaturation);
				float3 SnowBaseColor656_g14 = lerpResult31_g15;
				float2 uv_SnowNormal = IN.ase_texcoord4.zw * _SnowNormal_ST.xy + _SnowNormal_ST.zw;
				float3 unpack643_g14 = UnpackNormalScale( SAMPLE_TEXTURE2D( _SnowNormal, sampler_SnowNormal, uv_SnowNormal ), _SnowNormalIntensity );
				unpack643_g14.z = lerp( 1, unpack643_g14.z, saturate(_SnowNormalIntensity) );
	...
	UsePass "Hidden/Nature/Terrain/Utilities/SELECTION"
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv_SnowBaseColor = IN.ase_texcoord2.zw * _SnowBaseColor_ST.xy + _SnowBaseColor_ST.zw;
				float3 temp_output_12_0_g15 = (SAMPLE_TEXTURE2D( _SnowBaseColor, sampler_SnowBaseColor, uv_SnowBaseColor )).rgb;
				float dotResult28_g15 = dot( float3(0.2126729,0.7151522,0.072175) , temp_output_12_0_g15 );
				float3 temp_cast_1 = (dotResult28_g15).xxx;
				float3 lerpResult31_g15 = lerp( temp_cast_1 , temp_output_12_0_g15 , _SnowSaturation);
				float3 SnowBaseColor656_g14 = lerpResult31_g15;
				float2 uv_SnowNormal = IN.ase_texcoord2.zw * _SnowNormal_ST.xy + _SnowNormal_ST.zw;
				float3 unpack643_g14 = UnpackNormalScale( SAMPLE_TEXTURE2D( _SnowNormal, sampler_SnowNormal, uv_SnowNormal ), _SnowNormalIntensity );
				unpack643_g14.z = lerp( 1, unpack643_g14.z, saturate(_SnowNormalIntensity) );
	...
	UsePass "Hidden/Nature/Terrain/Utilities/SELECTION"
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float3 staticSwitch503_g14 = appendResult514_g14;
				#endif
				float2 uv_SnowNormal = IN.ase_texcoord5.zw * _SnowNormal_ST.xy + _SnowNormal_ST.zw;
				float3 unpack643_g14 = UnpackNormalScale( SAMPLE_TEXTURE2D( _SnowNormal, sampler_SnowNormal, uv_SnowNormal ), _SnowNormalIntensity );
				unpack643_g14.z = lerp( 1, unpack643_g14.z, saturate(_SnowNormalIntensity) );
				float3 SnowNormal657_g14 = unpack643_g14;
...
Node;AmplifyShaderEditor.RangedFloatNode;64;355.3268,259.6974;Inherit;False;Constant;_AlphaClipThreshold1;AlphaClipThreshold;1;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;53;333.8652,42.77539;Inherit;False;Terrain 4 Layer;0;;14;a8a57459582f78d4ca5db58f601fb616;4,504,1,102,1,669,1,668,1;0;7;FLOAT3;0;FLOAT3;14;FLOAT;56;FLOAT;45;FLOAT;200;FLOAT;282;FLOAT3;17
...
WireConnection;55;8;53;17
ASEEND*/
//CHKSM=207E1AFB586C99D5EE990A2BA5827DF4E08F406A