	...
	UsePass "Hidden/Nature/Terrain/Utilities/SELECTION"
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float3 vertexValue = localCalculateTangentsSRP76_g13;
						 ...
						 ) : SV_Target
			{
				...
				float3 temp_output_12_0_g14 = (SAMPLE_TEXTURE2D( _SnowBaseColor, sampler_SnowBaseColor, uv_SnowBaseColor )).rgb;
				float dotResult28_g14 = dot( float3(0.2126729,0.7151522,0.072175) , temp_output_12_0_g14 );
				float3 temp_cast_1 = (dotResult28_g14).xxx;
				float3 lerpResult31_g14 = lerp( temp_cast_1 , temp_output_12_0_g14 , _SnowSaturation);
				float3 SnowBaseColor656_g13 = lerpResult31_g14;
				float2 uv_SnowNormal = IN.ase_texcoord8.zw * _SnowNormal_ST.xy + _SnowNormal_ST.zw;
				float3 unpack643_g13 = UnpackNormalScale( SAMPLE_TEXTURE2D( _SnowNormal, sampler_SnowNormal, uv_SnowNormal ), _SnowNormalIntensity );
				unpack643_g13.z = lerp( 1, unpack643_g13.z, saturate(_SnowNormalIntensity) );
				float3 tanToWorld0 = float3( WorldTangent.x, WorldBiTangent.x, WorldNormal.x );
				float3 tanToWorld1 = float3( WorldTangent.y, WorldBiTangent.y, WorldNormal.y );
				float3 tanToWorld2 = float3( WorldTangent.z, WorldBiTangent.z, WorldNormal.z );
				float3 tanNormal647_g13 = unpack643_g13;
				float3 worldNormal647_g13 = float3(dot(tanToWorld0,tanNormal647_g13), dot(tanToWorld1,tanNormal647_g13), dot(tanToWorld2,tanNormal647_g13));
				float SnowMask654_g13 = pow( saturate( ( saturate( ( ( 0.5 - 0.0 ) / ( (worldNormal647_g13).y - 0.0 ) ) ) + _SnowCoverageAmount ) ) , _SnowCoverageFalloff );
				float3 lerpResult674_g13 = lerp( localClipHoles453_g13 , SnowBaseColor656_g13 , SnowMask654_g13);
				...
				float3 staticSwitch503_g13 = appendResult514_g13;
				#endif
				float3 SnowNormal657_g13 = unpack643_g13;
				float3 lerpResult677_g13 = lerp( staticSwitch503_g13 , SnowNormal657_g13 , SnowMask654_g13);
				...
				float3 BaseColor = saturate( lerpResult674_g13 );
				float3 Normal = lerpResult677_g13;
				float3 Emission = 0;
				float3 Specular = 0.5;
...
Node;AmplifyShaderEditor.FunctionNode;49;347.8021,40.57027;Inherit;False;Terrain 4 Layer;0;;13;a8a57459582f78d4ca5db58f601fb616;4,504,1,102,1,669,1,668,1;0;7;FLOAT3;0;FLOAT3;14;FLOAT;56;FLOAT;45;FLOAT;200;FLOAT;282;FLOAT3;17
...
WireConnection;51;8;49;17
ASEEND*/
//CHKSM=B635E8C1105651442F1B78681F5EFA2F29F7D2D2