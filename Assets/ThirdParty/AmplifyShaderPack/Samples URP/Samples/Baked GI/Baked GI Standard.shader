...
Shader "AmplifyShaderPack/Baked GI Standard"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 URPDecodeInstruction984_g8(  )
			{
						 ...
						 ) : SV_Target
			{
				...
				float3 Normal976_g8 = temp_output_975_0_g8;
				float3 tanToWorld0 = float3( WorldTangent.x, WorldBiTangent.x, WorldNormal.x );
				float3 tanToWorld1 = float3( WorldTangent.y, WorldBiTangent.y, WorldNormal.y );
				float3 tanToWorld2 = float3( WorldTangent.z, WorldBiTangent.z, WorldNormal.z );
				float3 tanNormal841_g8 = Normal976_g8;
				float3 worldNormal841_g8 = normalize( float3(dot(tanToWorld0,tanNormal841_g8), dot(tanToWorld1,tanNormal841_g8), dot(tanToWorld2,tanNormal841_g8)) );
				float3 normalizeResult603_g8 = normalize( worldNormal841_g8 );
				float3 tanNormal1002_g8 = normalizeResult603_g8;
				half3 reflectVector1002_g8 = reflect( -WorldViewDirection, float3(dot(tanToWorld0,tanNormal1002_g8), dot(tanToWorld1,tanNormal1002_g8), dot(tanToWorld2,tanNormal1002_g8)) );
				float3 indirectSpecular1002_g8 = GlossyEnvironmentReflection( reflectVector1002_g8, 1.0 - _IndirectSpecularRoughness, _IndirectSpecularOcclusion );
				float3 lerpResult612_g8 = lerp( temp_cast_0 , ( indirectSpecular1002_g8 + step( float3( 1,1,1 ) , ( 1.0 - indirectSpecular1002_g8 ) ) ) , _IndirectSpecular);
				float3 tanNormal615_g8 = Normal976_g8;
				float3 worldNormal615_g8 = normalize( float3(dot(tanToWorld0,tanNormal615_g8), dot(tanToWorld1,tanNormal615_g8), dot(tanToWorld2,tanNormal615_g8)) );
				float2 temp_output_566_0_g8 = (IN.ase_texcoord8.zw*(unity_LightmapST).xy + (unity_LightmapST).zw);
				float2 temp_output_571_0_g8 = (IN.ase_texcoord9.xy*(unity_DynamicLightmapST).xy + (unity_DynamicLightmapST).zw);
				float3 bakedGI987_g8 = ASEBakedGI( worldNormal615_g8, temp_output_566_0_g8, true);
				float3 lerpResult988_g8 = lerp( float3( 1,1,1 ) , bakedGI987_g8 , _IndirectDiffuse);
				float3 temp_output_845_0_g8 = ( lerpResult988_g8 + step( float3( 1,1,1 ) , ( 1.0 - lerpResult988_g8 ) ) );
				float ase_lightIntensity = max( max( _MainLightColor.r, _MainLightColor.g ), _MainLightColor.b );
				float4 ase_lightColor = float4( _MainLightColor.rgb / ase_lightIntensity, ase_lightIntensity );
				float clampResult896_g8 = clamp( ase_lightColor.a , 0.0 , 1.0 );
				float3 tanNormal977_g8 = temp_output_975_0_g8;
				float3 worldNormal977_g8 = normalize( float3(dot(tanToWorld0,tanNormal977_g8), dot(tanToWorld1,tanNormal977_g8), dot(tanToWorld2,tanNormal977_g8)) );
				float3 normalizeResult748_g8 = ASESafeNormalize( ( WorldViewDirection + SafeNormalize(_MainLightPosition.xyz) ) );
				float dotResult750_g8 = dot( worldNormal977_g8 , normalizeResult748_g8 );
				float Dot_NdotH855_g8 = dotResult750_g8;
				float temp_output_848_0_g8 = ( 1.0 - ( ( 1.0 - Dot_NdotH855_g8 ) * _MainLightPosition.w ) );
				float3 temp_output_844_0_g8 = ( temp_output_845_0_g8 * clampResult896_g8 * temp_output_848_0_g8 );
				float dotResult759_g8 = dot( worldNormal977_g8 , SafeNormalize(_MainLightPosition.xyz) );
				float Dot_NdotL853_g8 = dotResult759_g8;
				float lerpResult604_g8 = lerp( ( _ShadowStrength * _ShadowStrength * 0.7978846 ) , ( _ShadowStrength * _ShadowStrength * sqrt( ( 2.0 / ( 2.0 * PI ) ) ) ) , _ShadowApproxmation);
				float RoughnessApproxmation860_g8 = lerpResult604_g8;
				float temp_output_693_0_g8 = ( ( max( Dot_NdotL853_g8 , 0.0 ) * RoughnessApproxmation860_g8 ) + ( 1.0 - RoughnessApproxmation860_g8 ) );
				float lerpResult877_g8 = lerp( ( saturate( ( ( ( max( Dot_NdotH855_g8 , 0.0 ) * temp_output_693_0_g8 * temp_output_693_0_g8 ) + _ShadowOffset ) / _ShadowSharpness ) ) * Dot_NdotH855_g8 ) , temp_output_848_0_g8 , _ShadowStrength);
				float3 temp_output_591_0_g8 = ( ase_lightColor.rgb * lerpResult877_g8 * ( _ShadowIntensity * 10.0 ) );
				float3 temp_output_881_0_g8 = saturate( ( temp_output_844_0_g8 + temp_output_591_0_g8 ) );
				
				float localSampleLightmapBicubic965_g8 = ( 0.0 );
				float3 tanNormal967_g8 = temp_output_975_0_g8;
				float3 worldNormal967_g8 = float3(dot(tanToWorld0,tanNormal967_g8), dot(tanToWorld1,tanNormal967_g8), dot(tanToWorld2,tanNormal967_g8));
				float3 NormalWS842_g8 = worldNormal967_g8;
				float3 normalWS965_g8 = NormalWS842_g8;
				float3 temp_output_968_0_g8 = ( worldNormal967_g8 * float3( -1,-1,-1 ) );
				float3 BackNormalWS766_g8 = temp_output_968_0_g8;
				float3 backNormalWS965_g8 = BackNormalWS766_g8;
				float2 UV1Static746_g8 = temp_output_566_0_g8;
				float2 staticUV965_g8 = UV1Static746_g8;
				float2 UV2Dynamic747_g8 = temp_output_571_0_g8;
				float2 dynamicUV965_g8 = UV2Dynamic747_g8;
				float3 bakeDiffuseLighting965_g8 = float3( 0,0,0 );
				float3 backBakeDiffuseLighting965_g8 = float3( 0,0,0 );
				float4 localURPDecodeInstruction984_g8 = URPDecodeInstruction984_g8();
				float4 decodeInstructions965_g8 = localURPDecodeInstruction984_g8;
				float localSampleDirectionBicubic961_g8 = ( 0.0 );
				float2 staticUV961_g8 = UV1Static746_g8;
				float2 dynamicUV961_g8 = UV2Dynamic747_g8;
				float4 staticDir961_g8 = float4( 0,0,0,0 );
				float4 dynamicDir961_g8 = float4( 0,0,0,0 );
				{
				    ...
				    float4 texSize;
				        ...
				        texSize = float4( width, height, 1.0 / float2( width, height ) );
				        staticDir961_g8 = SampleTexture2DBicubic( LM_IND_NAME, LM_SAMPLER, staticUV961_g8, texSize, float2( 1, 1 ), LM_SLICE );
				    #endif
				    #if defined( DYNAMICLIGHTMAP_ON )
				        unity_DynamicDirectionality.GetDimensions( width, height );
				        texSize = float4( width, height, 1.0 / float2( width, height ) );
				        dynamicDir961_g8 = SampleTexture2DBicubic( unity_DynamicDirectionality, samplerunity_DynamicLightmap, dynamicUV961_g8, texSize, float2( 1, 1 ), 0 );
				    #endif
				#endif
				}
				float4 staticDir965_g8 = staticDir961_g8;
				float4 dynamicDir965_g8 = dynamicDir961_g8;
				SampleLightmapBicubic( normalWS965_g8 , backNormalWS965_g8 , staticUV965_g8 , dynamicUV965_g8 , bakeDiffuseLighting965_g8 , backBakeDiffuseLighting965_g8 , decodeInstructions965_g8 , staticDir965_g8 , dynamicDir965_g8 );
				float Contribution_Shadow863_g8 = lerpResult877_g8;
				float3 lerpResult941_g8 = lerp( float3( 0,0,0 ) , ( bakeDiffuseLighting965_g8 * Contribution_Shadow863_g8 ) , _BakedGIEnable);
				

				float3 BaseColor = ( temp_output_898_0_g8 * ( lerpResult612_g8 * temp_output_881_0_g8 ) );
				...
				float3 BakedGI = lerpResult941_g8;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float3 normalizeResult603_g8 = normalize( worldNormal841_g8 );
				float3 tanNormal1002_g8 = normalizeResult603_g8;
				half3 reflectVector1002_g8 = reflect( -ase_worldViewDir, float3(dot(tanToWorld0,tanNormal1002_g8), dot(tanToWorld1,tanNormal1002_g8), dot(tanToWorld2,tanNormal1002_g8)) );
				float3 indirectSpecular1002_g8 = GlossyEnvironmentReflection( reflectVector1002_g8, 1.0 - _IndirectSpecularRoughness, _IndirectSpecularOcclusion );
				float3 lerpResult612_g8 = lerp( temp_cast_0 , ( indirectSpecular1002_g8 + step( float3( 1,1,1 ) , ( 1.0 - indirectSpecular1002_g8 ) ) ) , _IndirectSpecular);
				float3 tanNormal615_g8 = Normal976_g8;
				float3 worldNormal615_g8 = normalize( float3(dot(tanToWorld0,tanNormal615_g8), dot(tanToWorld1,tanNormal615_g8), dot(tanToWorld2,tanNormal615_g8)) );
				float2 temp_output_566_0_g8 = (IN.ase_texcoord4.zw*(unity_LightmapST).xy + (unity_LightmapST).zw);
				float2 temp_output_571_0_g8 = (IN.ase_texcoord8.xy*(unity_DynamicLightmapST).xy + (unity_DynamicLightmapST).zw);
				float3 bakedGI987_g8 = ASEBakedGI( worldNormal615_g8, temp_output_566_0_g8, true);
				float3 lerpResult988_g8 = lerp( float3( 1,1,1 ) , bakedGI987_g8 , _IndirectDiffuse);
				float3 temp_output_845_0_g8 = ( lerpResult988_g8 + step( float3( 1,1,1 ) , ( 1.0 - lerpResult988_g8 ) ) );
				float ase_lightIntensity = max( max( _MainLightColor.r, _MainLightColor.g ), _MainLightColor.b );
				...
				float3 normalizeResult748_g8 = ASESafeNormalize( ( ase_worldViewDir + SafeNormalize(_MainLightPosition.xyz) ) );
				float dotResult750_g8 = dot( worldNormal977_g8 , normalizeResult748_g8 );
				float Dot_NdotH855_g8 = dotResult750_g8;
				float temp_output_848_0_g8 = ( 1.0 - ( ( 1.0 - Dot_NdotH855_g8 ) * _MainLightPosition.w ) );
				float3 temp_output_844_0_g8 = ( temp_output_845_0_g8 * clampResult896_g8 * temp_output_848_0_g8 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float3 tanNormal615_g8 = Normal976_g8;
				float3 worldNormal615_g8 = normalize( float3(dot(tanToWorld0,tanNormal615_g8), dot(tanToWorld1,tanNormal615_g8), dot(tanToWorld2,tanNormal615_g8)) );
				float2 temp_output_566_0_g8 = (IN.ase_texcoord2.zw*(unity_LightmapST).xy + (unity_LightmapST).zw);
				float2 temp_output_571_0_g8 = (IN.ase_texcoord6.xy*(unity_DynamicLightmapST).xy + (unity_DynamicLightmapST).zw);
				float3 bakedGI987_g8 = ASEBakedGI( worldNormal615_g8, temp_output_566_0_g8, true);
				float3 lerpResult988_g8 = lerp( float3( 1,1,1 ) , bakedGI987_g8 , _IndirectDiffuse);
				float3 temp_output_845_0_g8 = ( lerpResult988_g8 + step( float3( 1,1,1 ) , ( 1.0 - lerpResult988_g8 ) ) );
				float ase_lightIntensity = max( max( _MainLightColor.r, _MainLightColor.g ), _MainLightColor.b );
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;43;512,0;Float;False;True;-1;2;UnityEditor.ShaderGraphLitGUI;0;12;AmplifyShaderPack/Baked GI Standard;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;20;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;True;True;0;True;_Cull;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;;0;0;Standard;41;Workflow;1;0;Surface;0;0;  Refraction Model;0;0;  Blend;0;0;Two Sided;1;0;Fragment Normal Space,InvertActionOnDeselection;0;0;Forward Only;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,;0;Translucency;0;0;  Translucency Strength;1,False,;0;  Normal Distortion;0.5,False,;0;  Scattering;2,False,;0;  Direct;0.9,False,;0;  Ambient;0.1,False,;0;  Shadow;0.5,False,;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;1;638163211719799797;Extra Pre Pass;0;0;DOTS Instancing;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;Debug Display;0;0;Clear Coat;0;0;0;10;False;True;True;True;True;True;True;True;True;True;False;;True;0
...
Node;AmplifyShaderEditor.FunctionNode;34;128,224;Inherit;False;Material Lighting;35;;8;b5db59747a6f5584db32cde93c4695e4;8,839,1,831,1,838,1,910,1,826,1,827,1,882,1,893,1;3;898;FLOAT3;0,0,0;False;975;FLOAT3;0,0,1;False;765;FLOAT3;0,0,1;False;3;FLOAT3;894;FLOAT3;948;FLOAT3;949
...
ASEEND*/
//CHKSM=368D960543102DF1A223813E35D59FC84F8C9409